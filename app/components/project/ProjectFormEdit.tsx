...
import { editProjectSchema } from "@/app/schema/projectSchema"
...
//   ]).optional(),
// })
const ProjectFormEdit = ({onCancel, initialValues}:ProjectFormEditProps)=>{
  ...
  const handleEditProject = async (value: z.infer<typeof editProjectSchema>)=>{
    try{
      ...
      formData.append("workspace_id", initialValues.workspace_id.toString())
  ...
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <Card className="w-full h-full border-none shadow-none">
        ...
        <Form {...form}>
            <form onSubmit={form.handleSubmit((value)=>{handleEditProject(value)})} className="flex flex-col gap-4">
              <div className="flex flex-col gap-y-5">
                <FormField
                  ...
                  render={({field})=>(
                    <FormItem>
                      <FormLabel>Proejct Name</FormLabel>
                      <FormControl>
      ...
      <Card className="w-full h-full border-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
            ...
            <p className="text-sm text-muted-foreground">
              Delete a project is irreversible action, it will remove all the information of this project
            </p>
